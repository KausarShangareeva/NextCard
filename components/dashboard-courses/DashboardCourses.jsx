    ...
    <div className={styles.page}>
      <header className={styles.head}>
        ...
        <p className={styles.sub}>
          Shared production view for the course-generation pipeline. Approved
          client requests land here; track who&apos;s building what, for whom,
          and at what cost.
        </p>
      </header>
        ...
        <div className={styles.alert}>
          ...
          <div className={styles.alertBody}>
            <div className={styles.alertTitle}>
              {pending.length} client request{pending.length === 1 ? "" : "s"}{" "}
              waiting to be approved
            </div>
            <div className={styles.alertSub}>
              Review them in Inbox · Course requests, then they appear in the
              production queue below.
            </div>
          </div>
      ...
      <section className={styles.panel}>
        ...
        {inProduction.length === 0 ? (
          <div className={styles.empty}>
            Nothing in production right now. Approve a request from Inbox to
